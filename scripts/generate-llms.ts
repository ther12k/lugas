...
\`LUGAS_RESPONSE_001\`–\`LUGAS_RESPONSE_005\` for typed response helpers.
...
- docs/roadmap.md — shipped beta surface and planned first-party batteries
- docs/choosing-lugas.md — positioning and framework comparisons
