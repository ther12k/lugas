# LugasJS v0.1.0-beta.2 Pre-Publication Checklist

| Field | Value |
|---|---|
| Package Source Commit | `7f08b166b392b4e3b3f968f97d6d06fe1ce0eec9` (tag must point here) |
| Attestation Commit | `7f08b166b392b4e3b3f968f97d6d06fe1ce0eec9` (checkout that ran the gate + builder) |
| Target Package | `lugas@0.1.0-beta.2` |
...
- [x] **Exact Tarball Preserved:** `lugas-0.1.0-beta.2.tgz` hash triple-checked (gate evidence = rehearsal result = actual bytes) and covered by `SHA256SUMS`.
...
git tag -a "v0.1.0-beta.2" "7f08b166b392b4e3b3f968f97d6d06fe1ce0eec9" -m "LugasJS v0.1.0-beta.2 release candidate"
...
npm view lugas@0.1.0-beta.2 version dist.integrity dist.tarball
npm dist-tag ls lugas                        # beta -> 0.1.0-beta.2 (NOT latest)

# 4. GitHub release with the attested artifacts
gh release create "v0.1.0-beta.2"   ./docs/releases/beta/lugas-0.1.0-beta.2.tgz   ./docs/releases/beta/SHA256SUMS   ./docs/releases/beta/provenance.json   ./docs/releases/beta/sbom.json   --title "v0.1.0-beta.2"   --notes-file ./docs/releases/beta/RELEASE_PACKET.md   --prerelease
```
