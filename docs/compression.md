...
| `text/event-stream` | [SSE](./sse.md) must never be buffered. |
...
- **Request-body decompression** — the [body budget](./body-limits.md) owns inbound bytes.

## Where next

- [Production hardening](./production.md) — the header policy these compose with.
- [SSE](./sse.md) — the streaming responses compression structurally protects.
- [Diagnostics](./diagnostics.md) — `LUGAS_COMPRESSION_001`, `LUGAS_ETAG_001`.
