...
3. **Production hardening** — secure headers (small, explicit, no invented strict CSP) and health/readiness helpers over the service lifecycle. **Dispatched** (M9-004, [#369](https://github.com/ther12k/lugas/issues/369); [ADR-0029](okf/decisions/0029-production-hardening.md), ODR-0013).
