...
4. **Observability and HTTP primitives** — multipart parsing with bounded consumption shipped on `main` (M9-005, [#372](https://github.com/ther12k/lugas/issues/372); [ADR-0030](okf/decisions/0030-multipart-forms.md), ODR-0014; [`docs/uploads.md`](uploads.md)); remaining: compression/ETag (**dispatched**, M9-007, [#379](https://github.com/ther12k/lugas/issues/379); [ADR-0033](okf/decisions/0033-compression-etag.md), ODR-0016), and a rate-limit *contract* whose storage stays application-owned. OpenTelemetry hooks shipped on `main` (M9-006, [#376](https://github.com/ther12k/lugas/issues/376); [ADR-0032](okf/decisions/0032-telemetry-hooks.md), ODR-0015; [`docs/telemetry.md`](telemetry.md)).
