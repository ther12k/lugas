...
4. **Observability and HTTP primitives** — multipart parsing with bounded consumption (**in progress**, M9-005, [#372](https://github.com/ther12k/lugas/issues/372); [ADR-0030](okf/decisions/0030-multipart-forms.md), ODR-0014), OpenTelemetry integration hooks (no SDK dependency), compression/ETag, and a rate-limit *contract* whose storage stays application-owned.
