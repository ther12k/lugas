...
4. **Observability and HTTP primitives** — multipart parsing with bounded consumption shipped on `main` (M9-005, [#372](https://github.com/ther12k/lugas/issues/372); [ADR-0030](okf/decisions/0030-multipart-forms.md), ODR-0014; [`docs/uploads.md`](uploads.md)); remaining: OpenTelemetry integration hooks (**dispatched**, M9-006, [#376](https://github.com/ther12k/lugas/issues/376); [ADR-0032](okf/decisions/0032-telemetry-hooks.md), ODR-0015), compression/ETag, and a rate-limit *contract* whose storage stays application-owned.
