...
description: "An application-owned Drizzle instance as a Lugas service."
---
...
A runnable example lives under [`examples/drizzle`](https://github.com/ther12k/lugas/tree/main/examples/drizzle/).
