...
The manifest uses the versioned `lugas-manifest-v1` format and is intended for humans, CI checks, coding agents, documentation generators, and future OpenAPI tooling. See [`manifest-v1.md`](/lugas/manifest-v1/).
...
- [`diagnostics.md`](/lugas/diagnostics/) — the `LUGAS_*` diagnostic catalog.
