...
description: "Named dependencies, the init traffic gate, and drain-ordered shutdown."
---
...
- **Not a module property**: services belong to the app; modules are only named route bags ([routing](/lugas/routing/)).

## Where next

- [Lifecycle details](/lugas/api-reference/#service-lifecycle-adr-0020) — the full shutdown outcome contract.
- [Testing](/lugas/testing/) — replacing services with fakes and asserting disposal.
- [Diagnostics](/lugas/diagnostics/) — the `LUGAS_*` codes a lifecycle failure can raise.
