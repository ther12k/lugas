...
Resolved patch values below are lock/CI-resolved; the "1.4.x latest patch" selector resolves at matrix run time and the exact version is archived per cell in CI ([matrix evidence](https://github.com/ther12k/lugas/blob/main/docs/reports/m6-compatibility.md)).
